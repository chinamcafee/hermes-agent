...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("gquota", "Show Google Gemini Code Assist quota usage", "Info",
               cli_only=True),
    CommandDef("team", "Manage Team Cloud connection and login state", "Configuration",
               cli_only=True, args_hint="[status|connect|login|use|off|logout|token|breaker]",
               subcommands=("status", "connect", "login", "use", "off", "logout", "token", "breaker")),
    CommandDef("cloud-backup", "Back up local memory and soul to MinIO", "Configuration",
               cli_only=True, aliases=("cloud_backup",),
               args_hint="[status|config|memory|soul]",
               subcommands=("status", "config", "memory", "soul")),
    CommandDef("soul", "Show team, local, and effective soul", "Configuration",
               cli_only=True, args_hint="[status|show|merge]",
               subcommands=("status", "show", "merge")),
