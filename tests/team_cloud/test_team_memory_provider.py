...
def _context():
    from team_cloud.memory.provider import TeamContext
...
def test_team_memory_provider_is_inactive_when_missing_config():
    from team_cloud.memory.provider import TeamMemoryProvider, TeamMemoryProviderConfig
...
def test_team_memory_provider_prefetch_calls_team_cloud_and_formats_context():
    ...
    assert "personal-1" in context_block
