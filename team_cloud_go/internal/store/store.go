...
type Backend interface {
	...
	CreateTeam(ctx context.Context, orgID, slug, name string) (Team, error)
	...
	RunPersonalBackup(ctx context.Context, orgID, memberID string) (BackupJob, error)
	...
	PreviewPersonalRestore(ctx context.Context, backupID, memberID, mode string) (RestorePreview, error)
	ExecutePersonalRestore(ctx context.Context, backupID, memberID, mode string) (RestoreExecution, error)
